                                    ...
                                    <div class="row" >
                                        <div class="col-sm-12 text-dark"><label class="form-label"
                                                style={{margin: "7px"}}><strong><span className="text-dark">First
                                                        Name</span></strong></label><input
                                                class="border rounded-pill border-1 border-success shadow-sm focus-ring focus-ring-primary form-control form-control-lg bounce animated"
                                        ...
                                        <div class="col text-dark"><label class="form-label" style={{margin: "7px"}}><strong><span
                                                        ...
                                                        Name</span></strong></label><input
                                                class="border rounded-pill border-1 border-success shadow-sm focus-ring focus-ring-primary form-control form-control-lg bounce animated"
                                                type="text" autocomplete="off" required="" data-bs-theme="light" /></div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 text-dark"><label class="form-label"
                                                style={{margin: "8px"}}><strong><span
                                                        >Butchery
                                                        Name</span></strong></label><input
                                                class="border rounded-pill border-1 border-primary shadow-sm focus-ring focus-ring-success form-control form-control-lg bounce animated"
                                                type="text" autocomplete="off" required="" /></div>
                                        <div class="col-sm-6 text-dark"><label class="form-label"
                                                style={{margin: "8px"}}><strong><span >Email
                                                        Address</span></strong></label><input
                                                class="border rounded-pill border-1 border-primary shadow-sm focus-ring focus-ring-success form-control form-control-lg bounce animated"
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="text-capitalize fw-bolder text-center text-primary mb-0">
                                            <strong><span className="text-success">First Branch</span></strong>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 text-dark"><label class="form-label"
                                                style={{margin: "8px"}}><strong><span >Phone
                                                        Number</span></strong></label><input
                                                class="border rounded-pill border-1 border-primary shadow-sm focus-ring focus-ring-success form-control form-control-lg bounce animated"
                                                type="tel" autocomplete="off" required="" /></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 text-dark"><label class="form-label"
                                                style={{margin: "8px"}}><strong><span
                                                ...
                                                class="border rounded-pill border-1 border-primary shadow-sm focus-ring focus-ring-success form-select form-select-lg bounce animated"
                                                required="">
